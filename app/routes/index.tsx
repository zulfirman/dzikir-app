                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    ...
                                    <p>أَسْتَغْفِرُ اللهَ (ثَلاَثاً) اللَّهُمَّ أَنْتَ السَّلاَمُ، وَمِنْكَ السَّلاَمُ،
                                        تَبَارَكْتَ يَـا ذَا الْجَلاَلِ وَاْلإِكْرَامِ</p>
                                </div>
                                <div className="col-md-4">
                                    <p>Laailaaha illallah wahdahu la syariika lahu, lahulmulku walahul hamdu wa huwa
                                        ...
                                        jaddi minkal jadd</p>
                                    <p>لاَ إِلَهَ إِلاَّ اللهُ وَحْدَهُ لاَ شَرِيْكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ
                                        الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيْرٌ، اللَّهُمَّ لاَ مَانِعَ لِمَا
                                        أَعْطَيْتَ، وَلاَ مُعْطِيَ لِمَا مَنَعْتَ، لاَ يَنْفَعُ ذَا الْجَدِّ مِنْكَ
                                        الْجَدُّ</p>
                                </div>
